...
>
> **Tento súbor hovorí len to, čo ideme robiť.** Odbyté zadania a štartovacie
> prompty k hotovým krokom sú presunuté do `docs/archiv-planov.md` — nič sa
> nezmazalo, len stiahlo z cesty (22.8.2026).
...
# Externé skilly pre frontend agentov (vkus + motion)
